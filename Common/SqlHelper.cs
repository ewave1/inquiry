...
namespace XTWL.DataAccess
{
    ...
    public partial class SqlHelper
    {
        ...
        /// </summary> 
        /// <returns></returns> 
        public static string GetConnSting(string con)
        {
            return con;
        }
        /// <summary> 
        ...
        /// </summary> 
        /// <returns></returns> 
        public static SqlConnection GetConnection(string con)
        {
            SqlConnection Connection = new SqlConnection(SqlHelper.GetConnSting(con));
            return Connection;
        }
        #endregion
